...
| :----------------------------------------------------------: | :----------------------------------------------------------: | ------------------------------------------------------------ | ------------------------------------------------------------ |
| <img src="https://qny.luckyblank.cn/typora/20260916-玻璃质感主题-Live2DCompanion-角色.png" alt="玻璃质感主题-Live2DCompanion-角色" style="zoom:50%;" /> | <img src="https://qny.luckyblank.cn/typora/20260916-玻璃质感主题-Live2DCompanion-行为.png" alt="玻璃质感主题-Live2DCompanion-行为" style="zoom:50%;" /> | <img src="https://qny.luckyblank.cn/typora/20260916-玻璃质感主题-Live2DCompanion-AI.png" alt="玻璃质感主题-Live2DCompanion-AI" style="zoom:50%;" /> | <img src="https://qny.luckyblank.cn/typora/20260916-玻璃质感主题-Live2DCompanion-系统.png" alt="玻璃质感主题-Live2DCompanion-系统" style="zoom:50%;" /> |
|                  **角色**（二次元治愈主题）                  |                  **行为**（二次元治愈主题）                  | **AI**（二次元治愈主题）                                     | **系统**（二次元治愈主题）                                   |
| <img src="https://qny.luckyblank.cn/typora/2026091617-二次元治愈主题-Live2DCompanion-角色.png" alt="二次元治愈主题-Live2DCompanion-角色" style="zoom:50%;" /> | <img src="https://qny.luckyblank.cn/typora/20260916-二次元治愈主题-Live2DCompanion-行为.png" alt="二次元治愈主题-Live2DCompanion-行为" style="zoom:50%;" /> | <img src="https://qny.luckyblank.cn/typora/20260916-二次元治愈主题-Live2DCompanion-AI.png" alt="二次元治愈主题-Live2DCompanion-AI" style="zoom:50%;" /> | <img src="https://qny.luckyblank.cn/typora/20260916-二次元治愈主题-Live2DCompanion-系统.png" alt="二次元治愈主题-Live2DCompanion-系统" style="zoom:50%;" /> |
...
- 在角色上滚动鼠标滚轮，可以按 5% 步进调整角色尺寸；默认按模型分别保存，也可在“角色”页将当前尺寸应用于全角色。
- 设置页“角色”页可在 10%～100% 之间调整角色不透明度；默认按模型分别保存，也可应用于全角色，且不会影响聊天框、气泡、点击特效或交互命中。
...
- 支持精细角色命中、完整透明窗口“背景检测”和全局鼠标穿透锁定三种交互范围；普通聊天只让角色与聊天框自身接收鼠标，周围透明空白保持穿透。锁定时自动隐藏底部聊天、收起长消息阅读器并暂停检测效果，保留未发送草稿，设置页开关仍可正常调整；解锁后不会自动重新打开聊天。
...
- 可直接在设置页调整当前模型的独立尺寸与透明度、预览动作与表情，并把角色移动到当前显示器的四角或中央。
- 设置页提供“玻璃拟态 / 治愈手账”两套主题；每套主题可独立选择玻璃、甜美、像素或科幻气泡。
- 设置页默认使用当前宠物的独立静态背景缓存，保持与动态模式一致的角色尺寸；可手动开启同步桌面动作的动态背景（会占用更高 CPU），并支持系统减弱动态效果偏好。
...
- 行为页可控制锁定宠物时是否继续显示 APP 回复与外部消息气泡；关闭只隐藏锁定期间的消息表面，不停止消息处理或历史记录。
- AI 页的“消息输出方式”可分别控制 APP 内部回复与外部输入消息是否在气泡中逐字流式显示；两项默认关闭，关闭时直接显示完整文字。
...
| 单击其他部位      | 普通点击回应、动作、气泡与轻量特效                                                                                                      |
| 快速双击 / 三击   | 夸奖回应 / 兴奋回应                                                                                                                     |
| 长按约 650 ms     | 头部触发摸头，其他部位触发安静陪伴                                                                                                      |
| 按住并移动约 6 px | 开始拖动宠物窗口，松开后保存位置                                                                                                        |
| 在角色上滚动滚轮  | 调整当前角色尺寸，范围为 10%～200%                                                                                                      |
| 右键角色          | 打开互动、聊天、模型、锁定和设置快捷菜单                                                                                                |
| 托盘图标          | 显示或隐藏角色                                                                                                                          |
| 托盘菜单          | 互动、切换角色、暂停动画、锁定、刷新模型、设置或退出；开启外部接入后可选择 APP/浏览器调试窗口，开启长截图且设置窗口可见时可截取当前 Tab |
| `Ctrl+Shift+D`     | 显示或隐藏宠物                                                                                                                          |
| `Ctrl+Shift+,`     | 打开设置                                                                                                                                |
| `Ctrl+Shift+P`     | 暂停或继续角色动画                                                                                                                      |
| `Ctrl+Shift+Enter` | 开启或关闭对话                                                                                                                          |
| `Ctrl+Shift+Space` | 触发一次随机互动                                                                                                                        |
| `Ctrl+Shift+E`     | 打开外部消息调试窗口；未开启外部消息接入时跳转到系统设置                                                                                |
| `Ctrl+Shift+L`     | 切换锁定状态                                                                                                                            |
| `Ctrl+Shift+R`     | 刷新模型列表                                                                                                                            |
| `Ctrl+Shift+Left`  | 切换到上一个角色                                                                                                                        |
| `Ctrl+Shift+Right` | 切换到下一个角色                                                                                                                        |
| `Ctrl+Shift+S`     | APP 长截图；未开启时会打开设置并提示开启，开启后截取当前选中的 Tab 页面                                                               |
| `Ctrl+Shift+Q`     | 关闭应用                                                                                                                                |

以上十二项均为系统级快捷键，可在设置的“行为”页逐项修改、恢复默认，或为已有功能添加额外的自定义快捷键；修改成功后立即生效。锁定后宠物窗口会完全穿透鼠标，也可通过锁定快捷键或系统托盘解除。
